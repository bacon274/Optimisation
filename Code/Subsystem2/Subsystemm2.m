%% %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%                         Subsystem 2 - Solar Modules                         %
%   This file is the implementation of Subsystem 2 optimisation and           %
%   analysis. This file aim is to find the maximum energy that can be         %
%   generated by each module relative to its positon. The effect of           %
%   the shading at each possible position for each module is considered       %
%   as this is the cause of the varying irradiance from module to module.     %
%   In order to treat each module as being maximised in terms of energy,      %
%   each module should have a relative value of resistance to reach a         %
%   maximum output.                                                           % 
%   The file runs independently and can be called with the whole system file  %
...
Best_Modules % module numbers of the chosen best module configuration
